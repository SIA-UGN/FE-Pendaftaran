    ...
    <SidebarContext.Provider value={contextValue}>
      <TooltipProvider delayDuration={0}>
        <div
          ...
          className={cn(
            "group/sidebar-wrapper has-data-[variant=inset]:bg-[var(--green)] flex min-h-svh w-full",
            className
          )}
          {...props}>
          {children}
  ...
  if (collapsible === "none") {
    return (
      <div
        data-slot="sidebar"
        className={cn(
          "bg-[var(--green)] text-[var(--yellow)] flex h-full w-(--sidebar-width) flex-col",
          className
        )}
        {...props}>
        {children}
    ...
    return (
      <Sheet open={openMobile} onOpenChange={setOpenMobile} {...props}>
        <SheetContent
          ...
          data-slot="sidebar"
          data-mobile="true"
          className="bg-[var(--green)] text-[var(--yellow)] w-(--sidebar-width) p-0 [&>button]:hidden"
          style={
            {
...
function SidebarTrigger({
  ...
  return (
    <Button
      ...
      {...props}>
      <PanelLeftIcon className="text-xl w-full"/>
...
function SidebarSeparator({
  ...
  return (
    <Separator
      ...
      className={cn("bg-[var(--green)]-border mx-2 w-auto", className)}
      {...props} />
  );
}
...
function SidebarMenuItem({
  ...
  return (
    <li
      ...
      className={cn("group/menu-item relative cursor-pointer text-white/80", className)}
      {...props} />
  );
}
