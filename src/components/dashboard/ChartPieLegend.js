...
const chartData = [
  { name: "Lulus", value: 12, color: "#22c55e" },
  { name: "Tidak Lulus", value: 23, color: "#ef4444" },
...
const renderActiveShape = (props) => {
  ...
  return (
    <g>
      <text x={cx} y={cy - 15} textAnchor="middle" className="text-2xl font-bold" fill={fill}>
        {value}
      </text>
      <text x={cx} y={cy + 5} textAnchor="middle" className="text-sm font-medium" fill="#6b7280">
        {payload.name}
      </text>
      <text x={cx} y={cy + 25} textAnchor="middle" className="text-xs" fill="#9ca3af">
