...
export const registrationService = {
  ...
  /**
   * Store personal identity (legacy)
  ...
  /**
   * Store address information (legacy)
  ...
  /**
   * Store academic background (legacy)
