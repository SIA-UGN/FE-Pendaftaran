    ...
    return (
        <div className="flex flex-col items-center px-4 sm:px-8 max-w-11/12 my-12 w-full gap-3 mx-auto">
            ...
            <div className="w-full flex justify-end">
                ...
                <p>Akun pendaftar wajib berada dalam status accepted untuk menentukan kelulusan. Silahkan verifikasi data pendaftar terlebih dahulu.</p>
                    </>
            )}
...
<h2 className="text-3xl sm:text-2xl font-semibold mb-2 mt-6 w-full border-b-1 border-gray-500 pb-2 text-[var(--green)]">
            ...
            <div className="w-full">
                <Button variant={"green"} className={"w-full "} disabled>Rejected</Button>
            </div>
            <div className="w-full flex justify-end">
                <Link href="/manager/verification/data-diri"><Button variant={"green"} className={"w-sm"}>Verifikasi Data</Button></Link>
            </div>
                ...
                <p className='text-center'>Akun pendaftar wajib berada dalam status accepted untuk menentukan kelulusan. Silahkan verifikasi ulang data pendaftar yang sudah diperbaiki.</p>
...
<h2 className="text-3xl sm:text-2xl font-semibold mb-2 mt-6 w-full border-b-1 border-gray-500 pb-2 text-[var(--green)]">
            ...
            <div className="w-full">
                <Button variant={"green"} className={"w-full "} disabled>Accepted</Button>
            </div>
                <h2 className="text-3xl sm:text-2xl font-semibold mb-2 mt-6 w-full border-b-1 border-gray-500 pb-2 text-[var(--green)]">
                    Status Kelulusan Pendaftar
                </h2>
