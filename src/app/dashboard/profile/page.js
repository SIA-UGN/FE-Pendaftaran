    ...
    return (
        <div className="flex flex-col items-center px-4 sm:px-8 max-w-11/12 my-12 w-full gap-3 mx-auto">
            ...
            <div className="w-full">
                <Button variant={"green"} className={"w-full "} disabled>Approved</Button>
            </div>
            ...
            <div className="w-full">
                <Button variant={"green"} className={"w-full "} disabled>Lulus</Button>
            </div>
            {/* Nominal Masuk */}
            <h2 className="text-3xl sm:text-2xl font-semibold mb-2 mt-6 w-full border-b-1 border-gray-500 pb-2 text-[var(--green)]">
                Nominal Masuk
            ...
            <div className="w-full">
                <Button variant={"green"} className={"w-full "} disabled>Rp500.000,-</Button>
            </div>
        </div>
    )
}