      ...
      <div className="w-10/12 mx-auto mt-8">
        ...
        {status === "Accepted" && (
            <div className="flex flex-col gap-5 items-center justify-center">
                      <p className="bg-green-700 font-bold text-lg w-full p-4 text-center absolute top-30">Selamat</p>
                      <p className="mt-24 w-md text-center">Anda dinyatakan <span className="font-bold text-green-800">lulus</span> seleksi pendaftaran mahasiswa baru.</p>
                      <p className="font-bold text-xl text-[var(--green)]">Universitas Global Nusantara</p>
        ...
        {status === "Rejected" && (
          <div className="flex flex-col gap-5 items-center justify-center">
                      <p  className="bg-red-500 font-bold text-lg w-full p-4 text-center absolute top-30 text-white">Mohon Maaf</p>
                      <p className="mt-24 w-md text-center">Anda dinyatakan <span className="font-bold text-red-600">tidak lulus</span> seleksi pendaftaran mahasiswa baru.</p>
                      <p className="font-bold text-xl text-[var(--green)]">Universitas Global Nusantara</p>
