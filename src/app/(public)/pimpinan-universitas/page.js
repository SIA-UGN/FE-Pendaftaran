...
const pimpinan = [
    // REKTOR
    {
        ...
        deskripsi: "Pemimpin tertinggi universitas yang bertanggung jawab atas pengelolaan akademik dan non-akademik. Memiliki pengalaman 25 tahun di bidang pendidikan tinggi dan manajemen perguruan tinggi Islam.",
    ...
    // WAKIL REKTOR
    {
        ...
        deskripsi: "Membawahi urusan akademik, kurikulum, pembelajaran, dan penjaminan mutu pendidikan. Berpengalaman dalam pengembangan kurikulum berbasis kompetensi dan akreditasi internasional.",
    ...
    },
    {
        ...
        deskripsi: "Mengelola administrasi umum, keuangan, aset, dan sarana prasarana universitas. Ahli dalam manajemen keuangan pendidikan dan tata kelola kampus modern.",
    ...
    },
    {
        ...
        deskripsi: "Bertanggung jawab atas pembinaan kemahasiswaan, organisasi kampus, beasiswa, dan pengembangan soft skills mahasiswa. Fokus pada pembentukan karakter dan kepemimpinan mahasiswa.",
    ...
    },
    {
        ...
        deskripsi: "Mengelola kerjasama institusional, riset, publikasi ilmiah, dan pengabdian masyarakat. Membangun jaringan dengan universitas dan lembaga dalam dan luar negeri.",
    ...
    // DEKAN FAKULTAS
    {
        ...
        deskripsi: "Memimpin fakultas yang mengembangkan ilmu syariah, hukum Islam, dan hukum positif. Berpengalaman dalam penelitian hukum ekonomi syariah dan hukum keluarga Islam.",
                        ...
                        pimpinan.map((item) => (
                            <div className='flex w-full gap-5 flex-col md:flex-row' key={item.nama}>
                                ...
                                <p className='flex flex-col gap-2 w-full'>
                                    <span className='text-2xl font-bold text-[var(--green)]'>{item.nama}</span>
                                    <span className='text-lg font-semibold text-[var(--green)]'>{item.posisi}</span>
                                    
                                    <span className='text-sm text-gray-500 w-2xl'>{item.deskripsi}</span>
