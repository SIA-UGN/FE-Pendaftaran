                                    ...
                                    <div className="flex flex-col items-center py-16 pb-16 px-4 sm:px-8 max-w-11/12 mx-auto">
                                        ...
                                        <div className='flex w-full gap-5 flex-col md:flex-row-reverse'>
                                            ...
                                            <div className="w-full md:w-1/2">
                                                ...
                                                <p>1. Lorem ipsum dolor sit amet, consectetuer adipiscing elit. Aenean commodo ligula eget dolor. 
...
5. In enim justo, rhoncus ut, imperdiet a, venenatis vitae, justo. </p>
                                            </div>
                                        </div>
                                    </div>
            </div>
