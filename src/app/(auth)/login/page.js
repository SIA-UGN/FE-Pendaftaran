...
export default function Login() {
  ...
  return (
    <div className="flex items-center gap-6 w-screen h-screen justify-center bg-[url('/auth.png')] bg-cover ">
      <Card className="md:w-full max-w-7xl flex flex-col md:flex-row gap-2 p-12 md:p-0 h-full md:h-3/4 relative rounded-[5vw]">
          ...
          <CardContent>
            <form onSubmit={handleSubmit} className="grid gap-4">
              <div className="flex flex-col gap-6">
                ...
                <Button type="submit" className="w-full rounded-full text-white hover:text-white" variant={'matcha'} disabled={loading}>
